...
public class TopTradedFragment extends Fragment {
    ...
    private void findViews() {
        ...
        tvChange.setText(getResources().getString(R.string.trading_value));

        swipeContainer = getActivity().findViewById(R.id.swipeContainer);
        llm = new LinearLayoutManager(getActivity());
        rvTops.setLayoutManager(llm);

        adapter = new TopsRecyclerAdapter(getActivity(), allStocks, MyApplication.TOP_TRADED);
    ...
    private class GetTops extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                parameters.put("type", "" + MyApplication.TOP_TRADED);
