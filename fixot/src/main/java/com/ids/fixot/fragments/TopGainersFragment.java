...
public class TopGainersFragment extends Fragment{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Actions.setTypeface(new TextView[]{tvSymbol, tvPrice, tvChange, tvChangePercent}, MyApplication.lang == MyApplication.ARABIC ? MyApplication.droidbold : MyApplication.giloryBold);
    ...
    private void findViews() {
        ...
        //toolbarTitle = getResources().getString(R.string.top_gainer);
        ...
        //Actions.initializeToolBar(toolbarTitle, getActivity());

        swipeContainer = getActivity().findViewById(R.id.swipeContainer);
        llm = new LinearLayoutManager(getActivity());
        rvTops.setLayoutManager(llm);

        adapter = new TopsRecyclerAdapter(getActivity(), allStocks, MyApplication.TOP_GAINERS);
    ...
    private class GetTops extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                parameters.put("type", "" + MyApplication.TOP_GAINERS);
